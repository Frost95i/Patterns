...
ProxyLogger Logger; // ILogger Logger = new ProxyLogger();
	...
	score(0)
{
	...
	//MyTools::FileLoggerSingletone::getInstance().WriteToLog(string(__FUNCTION__) + " was invoked");
...
void SBomber::ProcessKBHit()
{
	...
	DropCommand dropCom(vecDynamicObj);
	DropCommand dropCom1(vecDynamicObj);
	switch (c) {
	...
	case 'B':
		...
		dropCom1.setParams(FindPlane(), &bombsNumber, &score);
		dropCom1.Execute();
		break;
